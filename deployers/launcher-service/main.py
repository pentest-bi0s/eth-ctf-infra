...
class ServerInstance:
    ...
    def get_instance_details(self,client_socket):
        if(self.setup==""):
            ...
            self.set_balance("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266",0)
            try:
    ...
    def set_balance(self, address, balance_hex):
        payload = {
            "method": "anvil_setBalance",
            "params": [address, balance_hex],
            "id": 1,
            "jsonrpc": "2.0"
        }
        ...
        try:
            response = requests.post(self.rpc_url_local, json=payload, headers=headers)
